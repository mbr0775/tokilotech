    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 relative overflow-hidden" id="home">
      ...
      <div className="relative min-h-screen flex items-center justify-center pt-20 px-6">
        <div className="relative z-10 text-center max-w-6xl">
          ...
          {/* Main Heading */}
          <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-6 tracking-tight leading-[1.1] animate-fade-in animation-delay-200">
          ...
          {/* Subheading */}
          <p className="text-gray-400 text-lg md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in animation-delay-400">
          ...
          <div className="flex flex-wrap gap-4 justify-center animate-fade-in animation-delay-800">
            <div className="group flex items-center gap-2 px-6 py-3 bg-gray-800/50 border border-gray-700 rounded-full hover:border-[#24375a] hover:bg-gray-800 transition-all duration-300 cursor-pointer">
              <Zap size={18} className="text-[#91BF48] group-hover:animate-pulse" />
              <span className="text-gray-300 text-sm font-medium">Fast Deployment</span>
            </div>
            <div className="group flex items-center gap-2 px-6 py-3 bg-gray-800/50 border border-gray-700 rounded-full hover:border-[#24375a] hover:bg-gray-800 transition-all duration-300 cursor-pointer">
              <Brain size={18} className="text-[#91BF48] group-hover:animate-pulse" />
              <span className="text-gray-300 text-sm font-medium">AI-Powered</span>
            </div>
            <div className="group flex items-center gap-2 px-6 py-3 bg-gray-800/50 border border-gray-700 rounded-full hover:border-[#24375a] hover:bg-gray-800 transition-all duration-300 cursor-pointer">
              <Sparkles size={18} className="text-[#91BF48] group-hover:animate-pulse" />
              <span className="text-gray-300 text-sm font-medium">Scalable Solutions</span>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-6 h-10 border-2 border-gray-600 rounded-full flex justify-center">
            <div className="w-1.5 h-3 bg-[#91BF48] rounded-full mt-2 animate-scroll"></div>
          </div>
        </div>
      </div>
